module github.com/thedataflows/pulumi-contabo/provider

go 1.18

replace (
	contabo.com/openapi => ./cntb/openapi
	contabo.com/terraform-provider-contabo => github.com/contabo/terraform-provider-contabo v0.1.17
...
require (
	contabo.com/terraform-provider-contabo v0.1.17
...
require (
	...
	contabo.com/openapi v0.0.0 // indirect
