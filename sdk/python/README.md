...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `contabo` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-contabo
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-contabo/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-contabo/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-contabo_darwin_amd64_v1
│   └── pulumi-resource-contabo
├── pulumi-contabo_darwin_arm64
│   └── pulumi-resource-contabo
├── pulumi-contabo_linux_amd64_v1
│   └── pulumi-resource-contabo
├── pulumi-contabo_linux_arm64
│   └── pulumi-resource-contabo
├── pulumi-contabo_windows_amd64_v1
│   └── pulumi-resource-contabo.exe
└── pulumi-contabo_windows_arm64
    └── pulumi-resource-contabo.exe
```
